...
public class MbedValidatorAndCollectorVisitor extends AbstractValidatorAndCollectorVisitor implements IMbedVisitorWithoutDefault<Void> {
    ...
    public Void visitColorSensor(ColorSensor<Void> colorSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(colorSensor.getPort(), SC.COLOR, colorSensor.getMode()));
        return null;
    }
    ...
    public Void visitCompassSensor(CompassSensor<Void> compassSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(compassSensor.getPort(), SC.COMPASS, compassSensor.getMode()));
        return null;
    }
    ...
    public Void visitGestureSensor(GestureSensor<Void> gestureSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(gestureSensor.getPort(), SC.ACCELEROMETER, gestureSensor.getMode()));
        return null;
    }
    ...
    public Void visitGyroSensor(GyroSensor<Void> gyroSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(gyroSensor.getPort(), SC.ACCELEROMETER, gyroSensor.getMode()));
        return null;
    }
    ...
    public Void visitHumiditySensor(HumiditySensor<Void> humiditySensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(humiditySensor.getPort(), SC.HUMIDITY, humiditySensor.getMode()));
        return null;
    }
    ...
    public Void visitLedOnAction(LedOnAction<Void> ledOnAction) {
        ConfigurationComponent configurationComponent = checkActorByPortExists(ledOnAction, ledOnAction.getPort());
        requiredComponentVisited(ledOnAction, ledOnAction.getLedColor());
        if ( configurationComponent != null && configurationComponent.getComponentType().equals("CALLIBOT") ) {
            usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
        } else {
    ...
    public Void visitLightSensor(LightSensor<Void> lightSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(lightSensor.getPort(), SC.LIGHT, lightSensor.getMode()));
        return null;
    }

    @Override
    public Void visitLightStatusAction(LightStatusAction<Void> lightStatusAction) {
        ConfigurationComponent configurationComponent = checkActorByPortExists(lightStatusAction, lightStatusAction.getPort());
        if ( configurationComponent != null ) {
            if ( configurationComponent.getComponentType().equals("CALLIBOT") ) {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
            } else {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.LIGHT));
            }
        }
        return null;
    }
    ...
    public Void visitMotorOnAction(MotorOnAction<Void> motorOnAction) {
        ...
        ConfigurationComponent configurationComponent = checkActorByPortExists(motorOnAction, motorOnAction.getUserDefinedPort());
        if ( configurationComponent != null ) {
            if ( configurationComponent.getComponentType().equals("CALLIBOT") ) {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
            } else {
                usedHardwareBuilder.addUsedActor(new UsedActor(motorOnAction.getUserDefinedPort(), configurationComponent.getComponentType()));
            }
        }
        return null;
    }
    ...
    public Void visitMotorStopAction(MotorStopAction<Void> motorStopAction) {
        ...
        ConfigurationComponent configurationComponent = checkActorByPortExists(motorStopAction, motorStopAction.getUserDefinedPort());
        if ( configurationComponent != null ) {
            if ( configurationComponent.getComponentType().equals("CALLIBOT") ) {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
            } else {
                usedHardwareBuilder.addUsedActor(new UsedActor(motorStopAction.getUserDefinedPort(), configurationComponent.getComponentType()));
            }
        }
        return null;
    }
    ...
    public Void visitPinGetValueSensor(PinGetValueSensor<Void> pinValueSensor) {
        ...
        usedHardwareBuilder.addUsedActor(new UsedActor(pinValueSensor.getPort(), SC.PIN_VALUE));
        return null;
    }
    ...
    public Void visitPinTouchSensor(PinTouchSensor<Void> pinTouchSensor) {
        usedHardwareBuilder.addUsedActor(new UsedActor(pinTouchSensor.getPort(), SC.PIN_VALUE));
        return null;
    }
    ...
    public Void visitServoSetAction(ServoSetAction<Void> servoSetAction) {
        ...
        ConfigurationComponent configurationComponent = checkActorByPortExists(servoSetAction, servoSetAction.getPort());
        if ( configurationComponent != null ) {
            if ( configurationComponent.getComponentType().equals("CALLIBOT") ) {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
            } else {
                usedHardwareBuilder.addUsedActor(new UsedActor(configurationComponent.getUserDefinedPortName(), SC.SERVOMOTOR));
            }
        }
        return null;
    }
    ...
    public Void visitSoundSensor(SoundSensor<Void> soundSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(soundSensor.getPort(), SC.SOUND, soundSensor.getMode()));
        return null;
    }
    ...
    public Void visitTemperatureSensor(TemperatureSensor<Void> temperatureSensor) {
        ...
        usedHardwareBuilder.addUsedSensor(new UsedSensor(temperatureSensor.getPort(), SC.TEMPERATURE, temperatureSensor.getMode()));
        return null;
    }

    @Override
    public Void visitTimerSensor(TimerSensor<Void> timerSensor) {
        usedHardwareBuilder.addUsedSensor(new UsedSensor(timerSensor.getPort(), SC.TIMER, timerSensor.getMode()));
        return null;
    }
    ...
    public Void visitUltrasonicSensor(UltrasonicSensor<Void> ultrasonicSensor) {
        ...
        ConfigurationComponent configurationComponent = checkActorByPortExists(ultrasonicSensor, ultrasonicSensor.getPort());
        if ( configurationComponent != null ) {
            if ( configurationComponent.getComponentType().equals("CALLIBOT") ) {
                usedHardwareBuilder.addUsedActor(new UsedActor("", SC.CALLIBOT));
            } else {
                usedHardwareBuilder.addUsedActor(new UsedActor(configurationComponent.getUserDefinedPortName(), SC.ULTRASONIC));
            }
        }
        return null;
    }
